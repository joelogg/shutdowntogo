	    	...
	    	<div class="row h-100 mh-100">
	    		...
	    		<div class="col-md-6">
	    			...
	    			<div class="col-12 col-sm-8 col-md-10 col-lg-8 col-xl-6 centrar">
		    			<div class="row">
		    				<div class="centrar">
		    					<img id="imagen" src=<?php echo $_SESSION["base_del_url"]."desarrollo/img/Icon_Key.svg";?>>	
		    				</div>
		    			</div>
		    			
		    			<div class="row">
		    				<div class="centrar">
		    					<p id="nombrePrincipal">Listo! Contraseña cambiada</p>
		    				</div>
		    			</div>

		    			<div class="row">
		    				<div class="centrar">
			    				<p id="nombreRevisa">ir a <a href=<?php echo $_SESSION["base_del_url"];?> >Inicio</a></p>
							</div>
		    			</div>
		    		</div>
	    		</div>
